...
from moviepy.editor import AudioFileClip, concatenate_audioclips, CompositeAudioClip, afx#type: ignore
from moviepy.audio.fx.all import audio_fadein, audio_fadeout, volumex#type: ignore
...
# faded_audio = audio1.audio_fadein(4).audio_fadeout(4)
# faded_audio.write_audiofile("faded_audio.mp3")

#  Adjust volume (reduce by 50%)
# quieter_audio = audio1.volumex(0.5)
